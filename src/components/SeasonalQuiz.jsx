...
export default function SeasonalQuiz({ questions, event, onFinish }) {
  const [qIndex, setQIndex] = useState(0)
  const [playerScores, setPlayerScores] = useState([0]) // Assuming single player for seasonal
  ...
  const playerScoresRef = useRef([0])
  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.topBar}>
        <div className={styles.pill}>Seasonal event</div>
      </div>
